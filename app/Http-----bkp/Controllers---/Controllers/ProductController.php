...
class ProductController extends Controller
{
    ...
    */
    public function create()
    {
        ...
        $categories = Category::all();
        return view('admin.product.create', compact('categories', 'news_letter_member'));
    }
    ...
    */
    public function update(Request $request, Product $product)
    {
        ...
        if ($request->category) 
        {
            ...
            $data_array = $request->except([
                '_token','media_token','_method','name','model','description','files','sku_code',
                'send_news_letter','similar_products','base_price','sell_price','similar_products','combo_qty','combo_discount','product_gst','in_stock','video_url','is_variations','variant_name','sku','product_weight',
            ]);
        ...
        $product->in_stock = number_format($request->in_stock);
    ...
    */
    ...
    public function changeNameOfAttributes($data_array){
        $data_array_keys = array_keys($data_array);
            ...
            $data_array_new_keys = array_map(function($val) { return str_replace('_', ' ', $val); }, $data_array_keys);
