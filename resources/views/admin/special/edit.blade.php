...
<div class="row">
    <div class="col-md-3">
        <div class="card-box">
            ...
            <hr>
            <form class="" action="" method="post" id="filter_listing">
                {{ csrf_field() }}
                <h5>Category</h5>

                <div class="checkbox checkbox-primary checkbox-single m-r-15 m-l-5">
                    <input id="test" type="checkbox" name="category" value="test">
                    <label for="test">
                        test
                    </label>
                </div>
            ...
            <table class="table mails table-bordered table-hover" id="lived_listing">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <img src="http://workfarmtoresto.bigdreams.in/storage/featured/8Gjy69YQCTMGkJYi4ol4CloWx0l7b6LvtikxamEb.jpeg" class="img-responsive" style="width: 80px;">
                        </td>
                        <td>ARU DESIGNER EMBROIDERED COTTON CHUDIDAR SUIT
                        SKU: DS 9, Category: Dress Material </td>
                        <td>1</td>
                        <td>1</td>
                        <td>
                            <div class="checkbox checkbox-primary checkbox-single m-r-15 m-l-5">
                                <input id="check4" type="checkbox" name="" value="">
