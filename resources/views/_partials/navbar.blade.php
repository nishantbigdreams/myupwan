        ...
        <div class="container-fluid">
            <div class="logo">
                <a href="{{ route('admin.home') }}" class="logo">
                    <img src="{{ asset('images/logo.png')}}" alt="logo" class="img-responsive" width="164" height="53"/>
            ...
            <div class="menu-extras">
                <ul class="nav navbar-nav navbar-right pull-right">
                  ...
                  {{--  --}}
                    ...
                    <li class="dropdown navbar-c-items ">
                        <a href="#" class="dropdown-toggle waves-effect waves-light profile" data-toggle="dropdown" aria-expanded="true"><img src="{{asset('images/users/avatar-1.png')}}" alt="user-img" class="img-circle"> </a>
        ...
        <div id="navigation">
            ...
            <ul class="navigation-menu">
                ...
                <li class="has-submenu">
                    ...
                    <ul class="submenu">
                        <li>
                             <a href="{{ url('/admin/excel_view') }}">
                                My Excel
                            </a>
                           <!--  <a href="{{ route('admin.excel.view') }}">
                                My Excel
                            </a> -->
                        </li>
                        <li>
                        ...
                        <li>
                         ...
                         <!--<li>
                            <a href="{{ route('admin.special_page') }}">
                                Special Offer Page
                            </a>
                        </li>-->
                        <li class="has-submenu">
                            ...
                            <ul class="submenu">
                                <li>
                                    <a href="{{ url('/admin/parent_category/create') }}">
                                        Parent Category
                                    </a>
                                </li>
                                <li>
                ...
                <li class="has-submenu">
                    ...
                    <ul class="submenu">
                        <li class="has-submenu">
                            ...
                            <ul class="submenu">
                                <li>
                                    <a href="{{ url('/admin/productattributemaster/create') }}">
                                        New Attribute Master
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ url('/admin/productattributemaster') }}">
                        ...
                        <li>
                            <a href="{{ url('/admin/productattibute') }}">
                                List Attribute
                            </a>
                        </li>
                        <li>
                            <a href="{{ url('admin/productattibute/create') }}">
                                Add Attribute
                            </a>
                        </li>
                        <!--<li>
                ...
                <li class="has-submenu">
                    ...
                    <ul class="submenu">
                        ...
                        <li>
                            <a href="{{ url('/admin/order/type/delivered') }}">
                                Completed
                            </a>
                        </li>
                        <li>
                            <a href="{{ url('/admin/order/type/cancelled') }}">
                                Cancelled
                            </a>
                        </li>
                        <li>
                            <a href="{{ url('/admin/order/type/return') }}">
                ...
                <li class="has-submenu">
                    ...
                    <ul class="submenu">
                        <li><a href="{{url('/admin/customer')}}">All Customers</a></li>
                    </ul>
                </li>
                <li class="has-submenu">
                    <a href="#"><i class="fa fa-user"></i>Contact Info</a>
                    <ul class="submenu">
                        <li><a href="{{url('/admin/contactuser')}}">All Customers</a></li>
                    </ul>
                </li>
                <li class="has-submenu">
                    <a href="#">
                    ...
                    <ul class="submenu">
                        <li>
                            <a href="{{ url('/admin/report/payment') }}">
                                Payments Reports
                            </a>
                        </li>
                        <li>
               ...
               <!--  <li>
                ...
                <li class="has-submenu">
                    ...
                    <ul class="submenu">
                        ...
                        <li>
                            <a href="{{ url('/admin/add_delivery_boy') }}">
                                Add Delivery Boy
                            </a>
                        </li>
                         
                        <li>
                            <a href="{{ url('/admin/all_delivery_boy') }}">
                                All Delivery Boy
                            </a>
                        </li>
                ...
                <!-- <li class="has-submenu pull-right">
                    ...
                    <ul class="submenu">
                        <li>
                            <a href="{{ route('admin.homepage.index') }}" target="_blank">
                             Home Page
                         </a>
                     </li>
                     <li>
