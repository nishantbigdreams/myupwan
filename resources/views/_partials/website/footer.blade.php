            ...
            <div class="row align-items-center">
                <div class="col-lg-3">
                    <a href="{{('/')}}" class="logo-footer">
                        <img src="{{asset('/images/logo-footer.png')}}" alt="logo-footer" width="200" height="89"/>
                    </a>
                    <!-- End FooterLogo -->
                </div>
                <div class="col-lg-9">
                        ...
                        <div class="col-md-3 col-sm-12">
                            <div class="widget">
                                ...
                                <ul class="widget-body">
                                    ...
                                    <li>
                                        <a href="{{url('/return_policy') }}">Shipping Policy</a>
                                    </li>
                                    <li>
                        ...
                        <div class="col-md-3 col-sm-12">
                            <div class="widget">
                                ...
                                <ul class="widget-body">
                                    ...
                                    <li>
                                        <a href="{{url('/own-grown') }}">Own Grown</a>
                                    </li>
                                </ul>
                            </div>
                            <!-- End Widget -->
                            ...
                            <div class="widget mb-0">
                                ...
                                <div class="widget-body">
                                    <li>
                                        ...
                                        @else
                                            <a href="{{url('/postLogin') }}">Sign in</a>
                                        @endif        
                                    </li>
                                    <li>
                                        <a href="{{url('/cartnew') }}">View Cart</a>
                                    </li>
                                    <li>
                                        @if(Auth::user())
                                            <a href="{{url('/mywishlist')}}">My Wishlist</a>
                                        @else
                                            <a href="{{url('/postLogin')}}">My Wishlist</a>
                                        @endif
                                    </li>
                                    <li>
        ...
        <div class="footer-bottom">
            <div class="footer-left">
                <figure class="payment">
                    <img src="{{asset('/images/payment.png')}}" alt="payment" width="300" height="29"/>
                </figure>
            </div>
            <div class="footer-center">
                <p class="copyright">My Upavan &copy; 2021. All Rights Reserved. Developed By <a
                            href="{{url('https://bigdreams.in/')}}" target="_blank">BIG DREAMS</a></p>
            </div>
        ...
        <ul class="mobile-menu mmenu-anim">
            ...
            <li>
                ...
                <ul>
                    ...
                    <li><a href="{{ url('/category/'.$mcatg->name)}}">{{$mcatg->name}}</a></li>
                    @endforeach
            ...
            <li>
                ...
                <ul>
                    ...
                    <li><a href="{{ url('/category/'.$seedcatg->name)}}">{{$seedcatg->name}}</a></li>
                    @endforeach
                    <!--<li><a href="#">Classic Filter</a></li>-->
                </ul>
            </li>
...
<!--<div class="newsletter-popup newsletter-pop3 mfp-hide" id="newsletter-popup">
    <div class="newsletter-content">
        ...
        <div class="d-flex form-check">
            ...
            <a href="{{url('/privacy_policy') }}" target="_blank" class="form-privacy">
                Privacy Policy
            </a>
        </div>
    </div>
