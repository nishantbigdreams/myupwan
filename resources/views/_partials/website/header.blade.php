...
<head>
    ...
    <!-- Preload Font -->
    <link rel="preload" href="{{ asset('newfonts/riode115b.ttf')}}" as="font" type="font/woff2" crossorigin="anonymous">
    ...
    <!-- Main CSS File -->
    <link rel="stylesheet" type="text/css" href="{{ asset('newcss/myupavan.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('newcss/custom.css')}}">
