                            ...
                            <div class="col-lg-7 mb-6 mb-lg-0 pr-lg-4">
                                ...
                                <div id="billing_address_div" class="panel-collapse collapse1 in">
                                    <div class="panel-body">
                                        ...
                                        @component('website.components.billing_address_subs',['dropdownValue' => $between])@endcomponent
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="summary pt-5">
                                        ...
                                        <table class="order-table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="product-name">Subscription Plan<span
                                                                class="product-quantity">×&nbsp;1</span></td>
                                                    <td class="product-total text-body">₹ 3600
                                                        </td>
                                                </tr>
                                            ...
                                            <tr class="summary-subtotal">
                                                ...
                                                <td class="summary-subtotal-price pb-0 pt-0" id="subtotal_value">₹ {{number_format(3600)}}
                                                </td>
                                            </tr>
                                            <tr class="summary-subtotal">
                                            ...
                                            <tr class="summary-total">
                                                ...
                                                <td class=" pt-0 pb-0">
                                                    <input class="grand_total" type="hidden" name="grand_total" value="{{$grand_total }}">

                                                    <p class="summary-total-price ls-s text-primary" id="grand_total">₹ {{number_format($grand_total)}}</p>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
            ...
            if ($(this).val().length == 6) {
                ...
                $.ajax({
                    ...
                    $.ajax({
                        ...
                        data : {"_token": "{{ csrf_token() }}",pincode : $this.val()},
...
<script>
    ...
    // "key" : "rzp_live_dL0I8usDDpY9vR";
    // "secret key" : "poErO9xm9OWxvODUu9CljZzW";
    var status = '';
