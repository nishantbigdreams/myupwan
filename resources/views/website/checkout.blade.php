                                        ...
                                        <table class="order-table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="summary-subtotal">
                                                    ...
                                                    <td class="summary-subtotal-price pb-0 pt-0"><button type="button" class="btn btn-md btn-dark btn-rounded btn-outline" onclick="fun_redeem_verify()">Apply Redeem Code</button><br><span style="color: red" id="success_message"></span></td>
                                                </tr>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if ($response.status == 1) {
                            ...
                            // $("#subtotal_value").text('₹' + 0);
                            $('.grand_total').val($response.grand_total);
                            $data = $('#grand_total').text('₹' + ($response.grand_total));
                            $('#grand_total').html('₹' + ($response.grand_total));
                            grand_total = $response.grand_total;
                            $("#redeem_id").val($redeem_point_id);
                            // $("#hide_online").hide();
