...
<div class="page-wrapper">
    ...
    <main class="main">
        ...
        <div class="page-header" style="background-image: url({{asset('images/page-header/contact-us.jpg')}})">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-6 d-flex align-items-center mb-4">
                            <div class="w-100">
                                <!-- <form class="pl-lg-2" action="{{url('contact')}}" method="post" id="contactform">
                                    {{csrf_field()}}
