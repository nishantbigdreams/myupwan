                                ...
                                <div class="d-flex align-items-center card">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12">    
                                        ...
                                        <div class="row justify-content-center">   
                                            ...
                                            @if(Auth::user())
                                            <a href="{{url('subs_checkout/3600')}}"  class="btn btn-success btn-shadow-lg btn-ellipse btn-block subs-btn">Buy Now</a>
                                            @else
                                            <a href="{{url('/postLogin')}}" class="btn btn-success btn-shadow-lg btn-ellipse btn-block subs-btn">Buy Now</a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
