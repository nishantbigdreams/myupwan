...
(function () {
    ...
    Riode.defaults = {
        ...
        minipopup: {
            ...
            purchasedTemplate: '<span class="purchased-time">CLICK ME</span>',

            template: '<div class="minipopup-box"><p class="minipopup-title">{{message}}</p>' +
            '<div class="product product-purchased {{productClass}} mb-0">' +
            '<figure class="product-mediapop"><a href="{{imageLink}}"><img src="{{imageSrc}}" alt="product" width="90" height="90"></a></figure>' +
    ...
    //             message: 'HAPPY TO HELP YOU GREETING!!!',
    //             productClass: 'product-cart',
    //             name: 'We are here for you, <br>If You need help in picking the right plant or have any doubts related to your order , Kindly share the queries & we shall revert.',
    //             nameLink: 'https://myupavan.com/category/popular-2022',
    //             imageSrc: '/images/categories/mini.jpg',
    //             isPurchased: true
    //         }, function ($box) {
                ...
                .on('click', '.product:not(.product-variable) .btn-product-icon.btn-cart, .product:not(.product-variable) .btn-product.btn-cart', function (e) {
                    ...
                    if ($compareCol.length > 0) {
                        ...
                        Riode.Minipopup.open({
                            ...
                            count: $product.find('.quantity').length > 0 ? $product.find('.quantity').val() : 1,
                            actionTemplate: '<div class="action-group d-flex"><a href="cartnew" class="btn btn-sm btn-outline btn-primary btn-rounded">View Cart</a></div>'
                        });
                    }
                })
           // <a href="#" class="btn btn-sm btn-primary btn-rounded">Check Out</a>
