...
<?php $__env->startSection('page-content'); ?>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="col-md-6">
                <div class="row">
                <form action="<?php echo e(route('admin.excel.upload_template')); ?>" enctype="multipart/form-data" method="POST">
                  <?php echo e(csrf_field()); ?>
        ...
        <div class="col-md-6" style="margin-top:5px;">
            ...
            <div class="col-md-6">
                <form action="<?php echo e(route('admin.excel.upload_product_template')); ?>" enctype="multipart/form-data" method="POST">
                  <?php echo e(csrf_field()); ?>
...
<?php $__env->startPush('page-script'); ?>
    ...
    let lived_list = $('#lived_listing').DataTable({
        ...
        'mark':true,
        "ajax": {
            "url" : "<?php echo e(route('admin.datatable.live.listing')); ?>",
            "type" : "POST",
            "data" : function(d){
