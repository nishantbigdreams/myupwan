                ...
                <section class="intro-section">
                    ...
                    <?php if($i%2 == 0){ ?>
                        <div class="intro-slide1 banner banner-fixed" style="background-color: #f6f6f6;">
                            <figure>
                                <img src="<?php echo e(url('public/sliderimg/'.$sliderdata->image)); ?>" alt="intro-banner"
                                width="1903"
                            ...
                            <div class="container">
                                <div class="banner-content y-50">
                                    ...
                                    <?php echo e($sliderdata->text_1); ?>

                                </h4>

                                <h2 class="banner-title slide-animate"
                                data-animation-options="{'name': 'fadeInUpShorter', 'duration': '1.2s', 'delay': '1s'}">
                                <?php echo e($sliderdata->text_2); ?></h2>
                                <a href="<?php echo e(url('/')); ?>/category/Popular 2022" class="btn btn-dark btn-rounded slide-animate"
...
<?php $__currentLoopData = $freshproducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="product text-center">
    <figure class="product-media">
        ...
        <div class="product-action-vertical">
            ...
            <a href="#" class="btn-product-icon btn-wishlist" data-rowid="<?php echo e($rowId); ?>"
            data-pid="<?php echo e($product->id); ?>" id="wishlist" title="Add to wishlist"><i
            ...
            <?php endif; ?>
                            ...
                            <div class="product-details">
                                ...
                                <div class="product-price">
                                    <span class="price">₹<?php echo e($product->sell_price); ?></span>
                                </div>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="row gutter-md category-grid">
                    <div class="height-x1">
                        <div class="category category-banner category-absolute overlay-light overlay-zoom text-white">
                            <a href="<?php echo e(url('/')); ?>/category/Low Maintenance">
                            ...
                            <div class="category-content">
                                ...
                                <a href="<?php echo e(url('/')); ?>/category/Low Maintenance" class="btn btn-underline btn-link btn-white">Shop
                                Now</a>
                            </div>
                        </div>
                    </div>
                    <div class="height-x1 w-2">
                        <div class="category category-banner category-absolute overlay-dark overlay-zoom">
                            <a href="<?php echo e(url('/')); ?>/category/Indoor Plants">
                                <figure class="category-media">
                            ...
                            <div class="category-content">
                                ...
                                <a href="<?php echo e(url('/')); ?>/category/Indoor Plants" class="btn btn-underline btn-link">Shop
                                Now</a>
                            </div>
                        </div>
                    </div>
                    <div class="height-x2">
                        <div class="category category-banner category-absolute overlay-light overlay-zoom text-white">
                            <a href="<?php echo e(url('/')); ?>/category/Flower Plants">
                                <figure class="category-media">
                ...
                <div class="height-x1 w-2">
                    <div class="category category-banner category-absolute overlay-dark overlay-zoom">
                        <a href="<?php echo e(url('/')); ?>/category/Cacti and Succulents">
                            <figure class="category-media">
                        ...
                        <div class="category-content">
                            ...
                            <a href="<?php echo e(url('/')); ?>/category/Cacti and Succulents" class="btn btn-underline btn-link">Shop
                            Now</a>
                        </div>
                    </div>
                </div>
                <div class="height-x1">
                    <div class="category category-banner category-absolute overlay-light overlay-zoom text-white">
                        <a href="<?php echo e(url('/')); ?>/category/Air Purifier Plants">
                            <figure class="category-media">
                    ...
                    <section class="ellipse-section container mt-10">
                        ...
                        <div class="code-template">
                            ...
                            <div class="category category-ellipse">
                                <a href="<?php echo e(url('/')); ?>/category/Fusion Plant">
                                    <figure class="category-media">
                                ...
                                <div class="category-content">
                                    <h4 class="category-name"><a href="<?php echo e(url('/')); ?>/category/Fusion Plant">Fusion Plants</a></h4>
                                </div>
                            </div>
                            <div class="category category-ellipse">
                                <a href="<?php echo e(url('/')); ?>/category/Green Plant">
                                    <figure class="category-media">
                                ...
                                <div class="category-content">
                                    <h4 class="category-name"><a href="<?php echo e(url('/')); ?>/category/Green Plant">Green Plants</a></h4>
                                </div>
                            </div>
                            <div class="category category-ellipse">
                                <a href="<?php echo e(url('/')); ?>/category/Red Plant">
                                    <figure class="category-media">
                                ...
                                <div class="category-content">
                                    <h4 class="category-name"><a href="<?php echo e(url('/')); ?>/category/Red Plant">Red Plants</a></h4>
                                </div>
                            </div>
                            <div class="category category-ellipse">
                                <a href="<?php echo e(url('/')); ?>/category/Yellow Plant">
                                    <figure class="category-media">
                                ...
                                <div class="category-content">
                                    <h4 class="category-name"><a href="<?php echo e(url('/')); ?>/category/Yellow Plant">Yellow Plants</a>
                                    </h4>
                                </div>
                            </div>
                            <div class="category category-ellipse">
                                <a href="<?php echo e(url('/')); ?>/category/Pink Plant">
                                    <figure class="category-media">
                                ...
                                <div class="category-content">
                                    <h4 class="category-name"><a href="<?php echo e(url('/')); ?>/category/Pink Plant">Pink Plants</a>
                                    </h4>
                                </div>
                            </div>
                        </div>
        ...
        <div class="post post-frame overlay-zoom">
            ...
            <div class="post-details">
                ...
                <a href="<?php echo e(url('/blogpost1')); ?>" class="btn btn-link btn-underline btn-primary">Read
            ...
            <div class="post post-frame overlay-zoom">
                ...
                <div class="post-details">
                    ...
                    <a href="<?php echo e(url('/blogpost2')); ?>" class="btn btn-link btn-underline btn-primary">Read
                        More<i class="d-icon-arrow-right"></i></a>
                    </div>
                </div>
                <div class="post post-frame overlay-zoom">
                    ...
                    <div class="post-details">
                        ...
                        <a href="<?php echo e(url('/blogpost3')); ?>" class="btn btn-link btn-underline btn-primary">Read
                            More<i class="d-icon-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
