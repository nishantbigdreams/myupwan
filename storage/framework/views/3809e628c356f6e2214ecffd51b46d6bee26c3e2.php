                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-md-7 mb-4">
                                <figure>
                                    <img src="<?php echo e(asset('images/about-1.jpg')); ?>" alt="Happy Customer" width="580"
                            ...
                            <div class="col-md-5 mb-4">
                                ...
                                <a href="<?php echo e(url('/subscription')); ?>" class="btn btn-dark btn-link btn-underline ls-m">buckle up and subscribe us now!<i
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-md-6 order-md-first mb-4">
                                ...
                                <a href="<?php echo e(url('/')); ?>/category/Popular 2022" class="btn btn-dark btn-link btn-underline ls-m">Have a look at our trending products<i
                                        class="d-icon-arrow-right"></i></a>
                            </div>
                            <div class="col-md-6 mb-4">
                                <figure>
                                    <img src="<?php echo e(asset('images/offer3.jpg')); ?>" alt="Our Store" width="580" height="507"
                    ...
                    <div class="container mt-8 mb-10">
                        ...
                        <div class="owl-carousel owl-theme row cols-xl-6 cols-lg-5 cols-md-4 cols-sm-3 cols-2"
                            ...
                            <figure class="brand-wrap bg-white banner-radius">
                                <img src="<?php echo e(asset('images/clients/ankita.jpg')); ?>" alt="Brand" width="180" height="100" />
                            </figure>
                            <figure class="brand-wrap bg-white banner-radius">
                                <img src="<?php echo e(asset('images/clients/apar.jpg')); ?>" alt="Brand" width="180" height="100" />
                            </figure>
                            <figure class="brand-wrap bg-white banner-radius">
                                <img src="<?php echo e(asset('images/clients/bright.jpg')); ?>" alt="Brand" width="180" height="100" />
                            </figure>
                            <figure class="brand-wrap bg-white banner-radius">
                                <img src="<?php echo e(asset('images/clients/gtpl.jpg')); ?>" alt="Brand" width="180" height="100" />
                            </figure>
                            <figure class="brand-wrap bg-white banner-radius">
                                <img src="<?php echo e(asset('images/clients/kokendra.jpg')); ?>" alt="Brand" width="180" height="100" />
                            </figure>
                            <figure class="brand-wrap bg-white banner-radius">
                                <img src="<?php echo e(asset('images/clients/lok.jpg')); ?>" alt="Brand" width="180" height="100" />
                            </figure>
                            <figure class="brand-wrap bg-white banner-radius">
                                <img src="<?php echo e(asset('images/clients/naidu.jpg')); ?>" alt="Brand" width="180" height="100" />
                            </figure>
                            <figure class="brand-wrap bg-white banner-radius">
                                <img src="<?php echo e(asset('images/clients/oce.jpg')); ?>" alt="Brand" width="180" height="100" />
                            </figure>
                            <figure class="brand-wrap bg-white banner-radius">
                                <img src="<?php echo e(asset('images/clients/sathi.jpg')); ?>" alt="Brand" width="180" height="100" />
                            </figure>
                            <figure class="brand-wrap bg-white banner-radius">
                                <img src="<?php echo e(asset('images/clients/strange.jpg')); ?>" alt="Brand" width="180" height="100" />
                            </figure>
                        </div>
                    </div>
                </section>
                        ...
                        <div class="row cols-sm-2 cols-md-4">
                            <div class="member appear-animate" data-animation-options="{'name': 'fadeInLeftShorter'}">
                                <figure class="banner-radius">
                                    <img src="<?php echo e(asset('images/subpages/team1.jpg')); ?>" alt="team member" width="280" height="280"
                            ...
                            <div class="member appear-animate"
                                ...
                                <figure class="banner-radius">
                                    <img src="<?php echo e(asset('images/subpages/team2.jpg')); ?>" alt="team member" width="280" height="280"
                            ...
                            <div class="member appear-animate"
                                ...
                                <figure class="banner-radius">
                                    <img src="<?php echo e(asset('images/subpages/team3.jpg')); ?>" alt="team member" width="280" height="280"
                            ...
                            <div class="member appear-animate"
                                ...
                                <figure class="banner-radius">
                                    <img src="<?php echo e(asset('images/subpages/team4.jpg')); ?>" alt="team member" width="280" height="280"
