 ...
 <div class="page-wrapper">
  ...
  <main class="main">
   <div class="page-header"
                           style="background-image: url(<?php echo e(asset('public/sliderimg/'. $category_image->category_image)); ?>)!important; background-color: #3C63A4;">
   <?php if(sizeof($products) ==0): ?>
   <h1 class="page-title">No Product Available</h1>
   <?php else: ?>
   <?php if($category_name == 'popular 2022'): ?>
                        <h1 class="page-title">Trending 2022</h1>

                        <?php elseif($category_name == 'Popular 2022'): ?>
                                                <h1 class="page-title">Trending 2022</h1>

                    <?php else: ?>
                        <h1 class="page-title"><?php echo e($category_name); ?></h1>
                    <?php endif; ?>
   <?php endif; ?>
   <ul class="breadcrumb">
        ...
        <div class="product shadow-media code-content">
         <figure class="product-media">
          ...
          <div class="product-action-vertical">
           ...
           <a class="btn-product-icon btn-cart addtocartbtn" id="addtocartbtn1" data-id="<?php echo e($plants->id); ?>" title="Select Options"><i class="d-icon-bag"></i></a>
           <?php
