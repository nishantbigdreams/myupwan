                        ...
                        <div class="height-x1">
                            <div class="category category-banner category-absolute overlay-light overlay-zoom text-white">
                                ...
                                <div class="category-content">
                                    ...
                                    <a href="<?php echo e(url('/')); ?>/category/Indoor Plants" class="btn btn-underline btn-link btn-white">Shop
                                        Now</a>
                                </div>
                            </div>
                        </div>
                        <div class="height-x1">
                            <div class="category category-banner category-absolute overlay-light overlay-zoom text-white">
                                ...
                                <div class="category-content">
                                    ...
                                    <a href="<?php echo e(url('/')); ?>/category/Flower Plants" class="btn btn-underline btn-link btn-white">Shop
                                        Now</a>
                                </div>
                            </div>
                        </div>
                        <div class="height-x1">
                            <div class="category category-banner category-absolute overlay-light overlay-zoom text-white">
                                ...
                                <div class="category-content">
                                    ...
                                    <a href="<?php echo e(url('/')); ?>/category/Air Purifier Plants" class="btn btn-underline btn-link btn-white">Shop
                                        Now</a>
                                </div>
                            </div>
                        </div>
