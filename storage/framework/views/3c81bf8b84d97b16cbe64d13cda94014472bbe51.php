...
<body>
                  ...
                  <div class="col-md-6">
                     <div class="product-gallery product-gallery-sticky mb-lg-9 mb-4">
                        <div class="product-single-carousel owl-carousel owl-theme owl-nav-inner row cols-1">
                           <?php $__currentLoopData = $product->gallerImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proimg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <figure class="product-image">
                              <img src="<?php echo e($proimg->url); ?>" data-zoom-image1="<?php echo e($proimg->url); ?>"
                                 alt="<?php echo e($product->name); ?>" width="600" height="675">
                           </figure>
                        ...
                        <div class="product-thumbs-wrap">
                           <div class="product-thumbs">
                              ...
                              <div class="product-thumb ">
                                 <img src="<?php echo e($proimg->url); ?>" alt="<?php echo e($product->name); ?>"
                     ...
                     <div class="product-details">
                        <div class="product-navigation">
                           <ul class="breadcrumb breadcrumb-lg">
                              ...
                              <li><a href="<?php echo e(('/product')); ?>" class="active">Products</a></li>
                              <li class="delimiter">/</li>
                              <li>View product</li>
                           </ul>
                        ...
                        <div class="product-price">
                           <ins class="new-price">₹<?php echo e($product->sell_price); ?></ins>
                           <del class="old-price">₹<?php echo e($product->base_price); ?></del>
                        </div>
                        <div class="ratings-container">
                           <div class="ratings-full">
                              <span class="ratings" style="width:<?php echo e($percentage); ?>%"></span>
                              <span class="tooltiptext tooltip-top"></span>
                           </div>
                           <a href="#product-tab-reviews" class="link-to-tab rating-reviews">( <?php echo e($no_review); ?> reviews )</a>
                        </div>
                        <p class="product-short-desc">Details</p>
                        <hr class="product-divider">
                        <form class="" action="<?php echo e(route('add_to_cart', $product)); ?>" method="post">
                        ...
                        <div class="product-footer">
                           ...
                           <div class="product-action mr-4">
                              ...
                              ?>
                              <?php if(!auth::user()): ?>
                              <a href="<?php echo e(url('postLogin')); ?>" class="btn-product1 btn-wishlist1 mr-6"
                                 data-rowid="<?php echo e($rowId); ?>" data-pid="<?php echo e($product->id); ?>" id="wishlist"><i
                                 class="far fa-heart"></i>Add to wishlist</a>
                              <?php endif; ?>
                              <?php if(auth::user()): ?>
                              <?php if($product->wish_list == 0): ?>
                              <a href="#" class="btn-product1 btn-wishlist1 mr-6" data-rowid="<?php echo e($rowId); ?>"
                                 data-pid="<?php echo e($product->id); ?>" id="wishlist"><i class="far fa-heart"></i>Add
                              to wishlist</a>
                              <?php else: ?>
                              <a href="<?php echo e(url('mywishlist')); ?>" class="btn-product1 btn-wishlist1 mr-6 added"
                                 data-rowid="<?php echo e($rowId); ?>" data-pid="<?php echo e($product->id); ?>" id="wishlist11"
                        ...
                        <div class="accordion accordion-simple mb-4">
                           <div class="card border-no card-description">
                              ...
                              <div id="collapse1-1" class="card-body expanded">
                                 <div class="row mt-5">
                                    <div class="mb-4">
                                       <div class="desc-p"><?php echo $product->description; ?></div>
                                       <br>
                                       <?php if(sizeof($productattributes) != 0): ?>
                                          ...
                                          <div class="col-xl-5 col-lg-5 col-sm-4 col-6 mb-4">
                                             <div class="category category-icon code-content">
                                                <figure class="category-media icons-img">
                                                   <img src="<?php echo e(url('public/productattributeimg/'.$productattribute->productattributemaster->image)); ?>" alt="img">
                                                </figure>
                                                <div class="category-content">
                                                   <h4 class="category-name" style="color: #704e4b;"><?php echo e($productattribute->productattributemaster->name); ?></h4>
                                                   <p style="margin: 0; color: #68b723;"><?php echo e($productattribute->text); ?></p>
                                                </div>
                                             </div>
                                          </div>
                                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="card card-reviews">
                           <div class="card-header">
                              <a href="#collapse1-4" class="expand">Reviews (<?php echo e($no_review); ?>)</a>
                           </div>
                           <div class="card-body collapsed" id="collapse1-4">
                              <div class="row">
                                 <div class="col-12 mb-6">
                                    <div class="avg-rating-container">
                                       <mark><?php echo e($avg_stars); ?></mark>
                                       <div class="avg-rating">
                                          ...
                                          <div class="ratings-container mb-0">
                                             ...
                                             <span class="rating-reviews">(<?php echo e($no_review); ?> Reviews)</span>
                                          </div>
                                       </div>
                                    </div>
                                    ...
                                    <?php if(Auth::user()): ?>
                                        ...
                                        <?php else: ?>
                                          <a class="btn btn-dark btn-rounded" href="<?php echo e(url('/postLogin')); ?>">Submit Review</a>
                                 ...
                                 <div class="col-12 comments pt-2 pb-10 border-no">
                                    ...
                                    <ul class="comments-list">
                                    	<?php if($no_review>0): ?>
                                    		<?php $__currentLoopData = $reviewData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reviewDatakey): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    		<li>
	                                          <div class="comment">
	                                             ...
	                                             <div class="comment-body">
	                                                <div class="comment-rating ratings-container">
	                                                   <div class="ratings-full">
	                                                      <span class="ratings"
	                                                         style="width:<?php echo e($reviewDatakey->rating*20); ?>%"></span>
	                                                      <span
	                                                ...
	                                                <div class="comment-user">
	                                                   <span class="comment-date">by 
                                                         ...
                                                         <?php if($reviewDatakey->name == ""): ?>
                                                         <span class="font-weight-semi-bold text-uppercase text-dark">My Upavan Customer</span> on
                                                         <?php else: ?>
                                                            <span class="font-weight-semi-bold text-uppercase text-dark"><?php echo e($reviewDatakey->name); ?></span> on
                                                         <?php endif; ?>

                                                          
	                                                   <span
	                                                      class="font-weight-semi-bold text-dark"><?php echo e($reviewDatakey->create_date); ?></span></span>
	                                                </div>
	                                                <div class="comment-content mb-5">
	                                                   <p><?php echo e($reviewDatakey->review); ?>
            ...
            <section class="pt-3 mt-2">
              <h2 class="title justify-content-center ls-normal mb-10 title-underline text-center">Similar Products</h2>
                <div class="owl-carousel owl-theme owl-nav-full row cols-2 cols-md-3 cols-lg-4"
                  ...
                  <?php $__currentLoopData = $recentarrival; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                  <div class="product text-center">
                    <figure class="product-media">
                      <a href="<?php echo e(url('product/'.$product->category.'/'.$product->sku.'/'.$product->id)); ?>">
                        <img src="<?php echo e(featuredImage($product)); ?>" class="custom-product-img" alt="product"
                        width="300" height="338">
                        <img src="<?php echo e(featuredImage2($product)); ?>" class="custom-product-img" alt="product"
                        width="300"
                        height="338">
                      </a>
                      ...
                      <div class="product-action-vertical">
                        ...
                        <input type="hidden" id="pid" name="pid" value=<?php echo e($product->id); ?>>
                        <a class="btn-product-icon btn-cart addtocartbtn1" id="addtocartbtn1"
                        data-id="<?php echo e($product->id); ?>" title="Select Options"><i class="d-icon-bag"></i></a>
                        <?php
                        $rowId = isProductInWishlist($product);
                        ?>
                        <?php if(!auth::user()): ?>
                        <a href="<?php echo e(url('postLogin')); ?>" class="btn-product-icon btn-wishlist1"
                        ...
                        data-rowid="<?php echo e($rowId); ?>" data-pid="<?php echo e($product->id); ?>" id="wishlist1"
                        title="Add to wishlist"><i class="d-icon-heart"></i></a>
                        <?php else: ?>
                        <a href="<?php echo e(url('mywishlist')); ?>" class="btn-product-icon btn-wishlist1 added"
                    ...
                    <div class="product-details">
                      <h3 class="product-name">
                        <a href="<?php echo e(url('product/'.$product->category.'/'.$product->sku.'/'.$product->id)); ?>"><?php echo e($product->name); ?></a>
                      </h3>
   ...
   <script>
      $('#wishlist').click(function () {
       ...
       $.ajax({
        method: 'post',
        url: "<?php echo e(route('wishlist',$product)); ?>",
   ...
   <script type="text/javascript">
    ...
    $('#save_review').click(function(){
        ...
        if(review == ""){
        	...
        	$.ajax({
            	url: "<?php echo e(route('sub_review')); ?>",
            	type: "POST",
            	headers: {
