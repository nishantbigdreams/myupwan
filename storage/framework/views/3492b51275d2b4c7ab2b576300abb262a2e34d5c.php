                        ...
                        <div class="col-md-8">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control input-sm" placeholder="Enter New Category Name" required="" name="name" value="<?php echo e(old('name')); ?>">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control input-sm" placeholder="SKU Initail" required="" name="sku_initial" value="<?php echo e(old('sku_initial')); ?>">
