...
<body>
                                    ...
                                    <div class="summary pt-5">
                                        ...
                                        <table class="order-table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="summary-subtotal" id="redeem_verify">
                                                ...
                                                <tr class="summary-subtotal">
                                                    ...
                                                    <td><input type="text" name="redeem_code" class="input-text form-control text-grey ls-m mb-4" id="redeem_code" placeholder="Enter redeem code here..."></td>
                                                    <td class="summary-subtotal-price pb-0 pt-0"><button type="button" class="btn btn-md btn-dark btn-rounded btn-outline" onclick="fun_redeem_verify()">Apply Redeem Point</button><br><span style="color: red" id="redeem_point_message"></span></td>
                                                </tr>
                                        ...
                                        <div class="payment accordion radio-type">
                                            ...
                                            <div class="card" id="hide_online">
                                                <div class="card-header">
                                                    <a href="#ONLINE" id="paymentonline" class="collapse text-body text-normal ls-m">Online payments
                                                    </a>
                                                </div>
    ...
    <script type="text/javascript">
        ...
        // console.log($("#coupen_id").val());
        // console.log(grand_total);


        function fun_redeem_verify() {
            var redeem_code = $("#redeem_code").val();
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if ($response.status == 1) {
                            ...
                            // $redeem_point_id = $response.redeem_id;/
                            // $("#flag_coupen").val("1");
                            // $("#redeem_point_message").append('');
                            // $("#redeem_point_message").append($response.message);
                            $("#subtotal_value").html();
                            $('.grand_total').val($response.grand_total);
                            $('#grand_total').html('₹' + ($response.grand_total));
                            $("#flag_coupen").val("2");
                            $("#redeem_code").val($response.redeem_point);
                            ...
                            swal(
                                '<b style="color:green">Success </b>',
                                '  <b style="color:black;">Redeem point is successfully applied</b> ',
                                'success'
                            )
                            ...
                            swal(
                                '<b style="color:red">Error! </b>',
                                '<b style="color:black;">Please enter valid redeem point</b>',
                                'error'
                            )
                        }
                        code = $("#coupon_code").val();
