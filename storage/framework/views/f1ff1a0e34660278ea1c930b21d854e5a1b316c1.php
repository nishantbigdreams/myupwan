            ...
            <div class="card-box">
                ...
                <div class="col-md-12">
                    <div class="card-box tilebox-two tilebox-success">
                        ...
                        <h2 class="m-b-10" data-plugin="counterup">
                            <?php echo e(number_format($data['new_order'])); ?>
                ...
                <div class="col-md-12">
                    <div class="card-box tilebox-two tilebox-primary">
                        ...
                        <h2 class="m-b-10" data-plugin="counterup">
                            <?php echo e(number_format($data['todays_sale'])); ?>
                ...
                <div class="col-md-12">
                    <div class="card-box tilebox-two tilebox-pink">
                        ...
                        <h2 class="m-b-10" data-plugin="counterup">
                            <?php echo e(number_format($data['month_sale'])); ?>
                ...
                <div class="col-md-12">
                    <div class="card-box tilebox-two tilebox-info">
                        ...
                        <h2 class="m-b-10" data-plugin="counterup">
                            <?php echo e(number_format($data['user_count'])); ?>
